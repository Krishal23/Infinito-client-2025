...
//   const initialPlayer = { fullname: "", email: "", phoneNumber: "", aadharId: "", collegeId: ""};
...
//     players: Array(14).fill(0).map(() => ({ ...initialMember })),
...
const Football_ = () => {
  return <EventForm config={eventConfigs.football} />;
};
